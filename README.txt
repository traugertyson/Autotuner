...
This also can be used with an arduino (or similar device) to automatically tune the guitar. The setup I have testd with is an arduino listening on the serial port /dev/ttyACM0. This program sends a 1 if the string is flat and a 2 if the string is sharp. 
